...
public class Teacher extends Staff {
	...
	public Teacher(String department, String speciality, double postAllowance, String name, String address, int age,
			int sex, double salary, LocalDate dateHired) {
	...
	public String toString() {
		return "Teacher [department=" + department + ", speciality=" + speciality + ", salary=" + getSalary()
				+ ", postAllowance=" + postAllowance + ", name=" + getName() + ", address=" + getAddress() + ", age="
				+ getAge() + ", sex=" + getSex() + ", dateHired=" + getDateHired() + "]";
	}
